public class Main {
    ...
    public static void main(String[] args) {
        ...
        Cell[][] maze = {
                ...
                { new Cell(1, 0, 1), new Cell(1,1,0),  new Cell(1,2,0), new Cell(1,3,0), new Cell(1,4,0), new Cell(1,5,0), new Cell(1,6,0), new Cell(1,7,0), new Cell(1,8,0), new Cell(1,9,0)},
                ...
                { new Cell(5, 0, 0), new Cell(5,1,0),  new Cell(5,2,0), new Cell(5,3,0), new Cell(5,4,0), new Cell(5,5,0), new Cell(5,6,0), new Cell(5,7,0), new Cell(5,8,0), new Cell(5,9,0)},
                ...
                { new Cell(9, 0, 0), new Cell(9,1,0),  new Cell(9,2,0), new Cell(9,3,0), new Cell(9,4,0), new Cell(9,5,0), new Cell(9,6,0), new Cell(9,7,1), new Cell(9,8,1), new Cell(9,9,1)},
        };
        ...
        //MRDAT
        /*
        Cell[][] maze = new Cell[RADKY][SLOUPCE];

        for (int x = 0; x < RADKY; x++) {
            for (int y = 0; y < SLOUPCE; y++) {
                if((x == 5 && y == 5) || (x == 5 && y == 6) || (x == 5 && y == 7)) {
                    maze[x][y] = new Cell(x, y, 1);
                }
                else {
                    maze[x][y] = new Cell(x, y, 0);
                }
            }
        }

        Cell[][] maze2 = new Cell[RADKY][SLOUPCE];
        for (int x = 0; x < RADKY; x++) {
            for (int y = 0; y < SLOUPCE; y++) {
                    maze[x][y] = new Cell(x, y, 0);
            }
